...
//    @Query("select new com.company.model.dto.MaterialDto(m.id, m.name, m.amount, m.article) from Material m where m.state = true")
//    List<MaterialDto> getMaterialDtoListByState();
